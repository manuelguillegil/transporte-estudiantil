...
CREATE table estudiantes(
	...
	"Nombre Completo" CHARACTER NOT NULL, 
...
copy "Censo" ("Carnet", "Nombre Completo", "Medio de Transporte", "Zona donde vive", "Relacion", "Hora a la que llega a la universidad [Lunes]", "Hora a la que llega a la universidad [Martes]", "Hora a la que llega a la universidad", "Hora a la que llega a la universidad [Jueves]", "Hora a la que llega a la universidad [Viernes]", "Sede", "Tipo de Ruta", "Ruta", "Tiempo en llegar a la Universidad") from '/home/mafer/Documentos/USB/Bases/Laboratorio/transporte-estudiantil/Censo Estudiantes Litoral.csv' delimiter ',' csv header;
...
-- Impoortamos el archivo cvs a la tabla creada
copy "Horarios Litoral" ("CARNET", "CEDULA", "APELLIDOS", "NOMBRES", "CODIGO_MATERIA", "SECCION", "DESCRIPCION", "creditos", "dia", "hora_inicio", "hora_fin") from '/home/mafer/Documentos/USB/Bases/Laboratorio/transporte-estudiantil/Horarios Litoral.csv'  delimiter ',' csv header;
...
CREATE TABLE public."Inscribe" (
    ...
    "Dia" character varying(50),
    "Materias" character varying(50) REFERENCES "Materia"
);
...
INSERT INTO "Ruta"("Nombre", "Tipo")
    ...
    FROM "Censo" WHERE "Ruta" IS NOT NULL AND "Tipo de Ruta" IS NOT NULL;
